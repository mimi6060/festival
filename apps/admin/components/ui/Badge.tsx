...
/**
 * Badge variant types - Standardized across all Festival Platform apps
 */
 ...
 * Light mode backgrounds with dark mode support
 */
 ...
 * Standard styling:
 * - Base: px-2 py-1 rounded-full text-xs font-medium
 * - Primary: bg-indigo-500/20 text-indigo-400 (dark mode)
 * - Success: bg-green-500/20 text-green-400 (dark mode)
 * - Warning: bg-yellow-500/20 text-yellow-400 (dark mode)
 * - Error: bg-red-500/20 text-red-400 (dark mode)
 *
 * @example
 * ```tsx
 * // Basic usage
