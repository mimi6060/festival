        ...
        <Card variant="solid" padding="lg">
          ...
          <div className="grid grid-cols-3 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 py-3 px-3 rounded-xl bg-theme-surface border border-theme text-theme-primary hover:bg-theme-surface-hover transition-colors"
            >
