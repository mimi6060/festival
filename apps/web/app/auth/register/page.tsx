...
export default function RegisterPage() {
  ...
  const validatePassword = (password: string): string | null => {
    ...
    // Optional but recommended: special character
      ...
      <div className="w-full max-w-md">
        ...
        <Card variant="solid" padding="lg">
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">Join FestivalHub and start your adventure</p>
          </div>
            ...
            <div className="space-y-3 pt-2">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 mt-1 rounded border-white/20 bg-white/5 text-primary-500 focus:ring-primary-500/50"
                />
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-white/70">
                  Send me festival news and exclusive offers (optional)
                </span>
              </label>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-festival-darker text-white/50">Or sign up with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 py-3 px-3 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-colors"
            >
