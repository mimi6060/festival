...
const POI_TYPES: { type: PoiType; label: string; icon: string; color: string }[] = [
  { type: 'STAGE', label: 'Scene', icon: 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3', color: 'text-purple-600 bg-purple-50' },
  { type: 'FOOD', label: 'Restauration', icon: 'M12 6v6m0 0v6m0-6h6m-6 0H6', color: 'text-orange-600 bg-orange-50' },
  { type: 'DRINK', label: 'Boissons', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', color: 'text-blue-600 bg-blue-50' },
  { type: 'TOILET', label: 'Toilettes', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', color: 'text-cyan-600 bg-cyan-50' },
  { type: 'MEDICAL', label: 'Medical', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', color: 'text-red-600 bg-red-50' },
  { type: 'INFO', label: 'Information', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', color: 'text-indigo-600 bg-indigo-50' },
  { type: 'ATM', label: 'Distributeur', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z', color: 'text-green-600 bg-green-50' },
  { type: 'PARKING', label: 'Parking', icon: 'M8 7h4a4 4 0 014 4 4 4 0 01-4 4H8V7zm0 0v10', color: 'text-slate-600 bg-slate-50' },
  { type: 'CAMPING', label: 'Camping', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', color: 'text-emerald-600 bg-emerald-50' },
  { type: 'ENTRANCE', label: 'Entree', icon: 'M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1', color: 'text-teal-600 bg-teal-50' },
  { type: 'EXIT', label: 'Sortie', icon: 'M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1', color: 'text-rose-600 bg-rose-50' },
  { type: 'CHARGING', label: 'Recharge', icon: 'M13 10V3L4 14h7v7l9-11h-7z', color: 'text-yellow-600 bg-yellow-50' },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900 mt-1">{typesUsed} / {POI_TYPES.length}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      {Object.entries(groupedPois).length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <p className="text-gray-500 mb-4">Commencez par ajouter des points d&apos;interet sur la carte.</p>
              ...
              <div key={type} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{pois.length} point{pois.length > 1 ? 's' : ''}</p>
                  </div>
                </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <span className={`badge ${poi.isActive ? 'badge-success' : 'badge-neutral'}`}>
