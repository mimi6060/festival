 ...
 * Account DTOs
 *
 * DTOs for cashless account creation and retrieval
 */
...
export class AccountResponseDto {
  ...
  @ApiProperty({ description: 'NFC tag ID', example: 'NFC-ABC123', nullable: true })
...
export class BalanceResponseDto {
  @ApiProperty({ description: 'Current balance in EUR', example: 125.5 })
  balance!: number;
}
